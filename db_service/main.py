...
from sqlalchemy import create_engine, Column, String, DateTime, Integer, Text, JSON, Float, Boolean, func, UniqueConstraint
...
class Ticket(Base):
    ...
    # Geocoded coordinates (populated by map_service geocoding job)
    lat               = Column(Float,  nullable=True)
    lng               = Column(Float,  nullable=True)
    # SLA tracking
    sla_deadline      = Column(DateTime, nullable=True)
    # False report
    is_false_report   = Column(Boolean, default=False, nullable=True)
...
class FalseReportPenalty(Base):
    __tablename__ = "false_report_penalties"
