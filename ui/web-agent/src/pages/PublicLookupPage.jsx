...
import { updateTicketByNumber } from "../utils/ticketStore";
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (filterType === "ticketNumber") {
        ...
        filtered = all.filter((r) => phoneDigits(r.phone || "").includes(k));
      }
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="plActions">
                  <button className="btn primary" type="submit" disabled={loading}>
                    {loading ? t("Searching…", "Recherche…") : copy.search}
                  </button>
                  <button className="btn" type="button" onClick={onClear} disabled={loading}>
                    {copy.clear}
                  </button>
                </div>
              </form>
