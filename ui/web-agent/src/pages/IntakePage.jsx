...
export default function IntakePage({ activeView: routeActiveView, view = "myWork" }) {
  ...
  const [userName, setUserName] = useState(localStorage.getItem("userName") || "Nagavalli");
  ...
  const sessionRoleUpper = String(sessionUserRole || "SUPERVISOR").toUpperCase();
  ...
  useEffect(() => {
    const onSessionChanged = () => {
      setUserName(localStorage.getItem("userName") || "Nagavalli");
      setUserRole(localStorage.getItem("userRole") || "SUPERVISOR");
    };
  ...
  const duplicateByTicketId = useMemo(() => {
    ...
    for (const candidate of duplicateCandidates || []) {
      ...
      const reverseItem = {
        ...item,
        parentTicketId: childId,
        similarTicketId: childId,
      };
