...
export default function TicketDetailsPage() {
  ...
  const sessionRole = upper(localStorage.getItem("userRole") || "SUPERVISOR");
  const sessionName = (localStorage.getItem("userName") || "Nagavalli").trim();
  ...
  const busy = approving || rejecting || resolving || escalating;
